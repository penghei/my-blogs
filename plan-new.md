...
- hexo的原理，搭博客的过程，博客页面的优化手段，防止面试官问到博客里的
- 想办法从各种题库、面试题总结、面经里扣手写题和不会的知识点，面向面经补充。当然自己面试的也要注意

需要巩固的主要有：

- **项目**：把项目按照star重新组织一下，写成具体的稿子。写在稿子内的内容一定要完全熟练，不怕追问。如果有不熟悉的，那么不熟悉的内容、知识点就是最需要巩固的。比如对轮播图实现的某个关键点不熟，那就把源码多看几遍
- rn
...
- redux笔记再复习和细看，redux官方文档看还有没有缺漏的地方
- mobx、recoil的官方文档，同样是看看缺漏的点，包括异步数据、接入react等等。recoil要重点看，找一些文章来看，最好有项目实际使用的那种。
- react ssr的小册和掘金文章，整理到笔记里
- 项目按照star写成稿子，然后所有和项目相关的技术内容八股都要熟悉，目前想到的有
  - 轮播图组件源码，之前忽略的逻辑，以及动画、样式等
  - 视频相关的，rn视频和web视频。这里考虑到一些优化手段，比如通用的针对视频的优化等等
  - 页面优化方式，尤其是渲染优化的，分布渲染的方式和意义（priority组件）、懒渲染的方式（可视区域），以及更多的优化细节。这里需要再细看mtdocs内的，以及一些好的rn优化文章
  - konva官方文档，主要是看完它的内容，搞清楚他做了哪些事，可以怎么做
  - 拖拽和放缩功能的具体实现逻辑，也在网上搜搜相关代码，看看其他实现方式
  - canvas优化内容，要做到搜到的所有可能的优化方式都要清楚原理，尤其是之前没仔细看的，比如脏矩形、分块渲染之类的。项目中实际应用的也要多搜一搜
  - 各种状态管理库的，上面已经说过的。关键是要好好想想recoil的使用，除了作为简单的eventBus之外还能怎么用，以及除了模板代码方面，其他的比redux更好在哪里
  - eslint、husky的原理性知识、配置内容，以及常用的代码规范化方式之类的
- 其他项目八股，包括
  - mtdocs内的rn八股和rn优化，要仔细看！
  - rn官方文档，就是上面说的那几个关键组件的api。这里可以搜一下rn相关面试题，然后对照面试题复习也行
  - canvas的mdn文档，包括各种api的用法、基本图像的画法等等，还有一些canvas的原理，比如之前的canvas绘制和dom的区别这种的
